...
Display results form Google Cloud Vision API call
...
Retrieve Image Data Use Case Complete - 90%

TODO:
Parse data returned from Cloud VIsion API to call the WIkipedia API which will go along witht he implementation of the Display Plant Information Use Case
